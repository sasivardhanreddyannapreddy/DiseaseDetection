disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        <br/> Cause of disease:
        <br/><br/> Fungal Pathogen: The primary cause of apple scab is the fungus Venturia inaequalis. The spores of this fungus are released during wet conditions, and they infect the apple tree's tissues, leading to the characteristic scab-like lesions.
        <br/> Environmental Conditions: Apple scab thrives in cool, moist conditions. Rain and high humidity provide an ideal environment for the fungus to spread and infect the trees. Poor air circulation within the canopy can also contribute to the development of the disease.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Cultural Practices:

Pruning: Proper pruning practices help improve air circulation within the tree canopy, reducing humidity and inhibiting the growth and spread of the fungus.
Thinning: Thinning the branches and foliage can also enhance air circulation and sunlight penetration, creating an environment less conducive to the development of apple scab.
